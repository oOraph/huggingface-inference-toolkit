...
inference-pytorch-cpu:
	docker build --build-arg="REQUIREMENTS=requirements.txt.cpu" --build-arg="BASE_IMAGE=ubuntu:22.04" --build-arg="RUNTIME_IMAGE=ubuntu:22.04" -f dockerfiles/pytorch/Dockerfile -t integration-test-pytorch:cpu .
